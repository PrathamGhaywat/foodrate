  ...
  async function loadReviews(nextCursor?: string | null) {
    ...
    try {
      ...
      if (msg.toLowerCase().includes("attribute not found") && msg.toLowerCase().includes("foodid")) {
        ...
        setReviewsSupportMsg(
          'The review collection is missing the "foodId" attribute. Add a string attribute named "foodId" (or a relationship to the food collection), then refresh.'
        );
        setReviews([]);
        setHasMore(false);
        setCursor(null);
